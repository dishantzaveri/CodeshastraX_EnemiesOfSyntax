...
export default function Charts() {
    ...
    const fetchData = async () => {
        ...
        fetch("https://71w0x6q2-8000.inc1.devtunnels.ms/news/Top25Fundedcompanybargraphapi/", requestOptions)
    ...
    const fetchGraphs = async () => {
        ...
        fetch("https://71w0x6q2-8000.inc1.devtunnels.ms/news/Fundingperregionbargraphapi/", requestOptions)
            .then(response => response.text())
            .then(result => console.log(result))
            .catch(error => console.log('error', error));
    }
...
const styles = StyleSheet.create({
    ...
    chart1: {
        ...
        borderRadius: 20,
        width: 350,
        backgroundColor: '#f58084', alignSelf: "center", alignContent: "center", justifyContent: "center"
    },
    chart2:
    {
        margin: 20,
