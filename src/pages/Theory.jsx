...
import {
  ...
  seniorAngularQeustions,
  javaQuestions,
  seniorJavaQuestions,
  cQuestions,
  seniorCQuestions,
  pythonQuestions,
  seniorPythonQuestions,
  dataScientistQuestions,
  seniorDataScientistQuestions,
  devOpsQuestions,
  cyberQuestions,
  seniorCyberQuestions,
...
const validationSchema = yup.object({
  answer: yup
    .string()
    .max(1000, "answer should be 100 characters max")
...
const Theory = () => {
  ...
  useEffect(() => {
    ...
    if (interviewJob === "React" && interviewLevel === "Senior") {
      const shuffledQuestions = reactQuestions.sort(() => Math.random() - 0.5);
      const shuffledSenior = seniorReactQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Angular" && interviewLevel === "Junior") {
      const shuffledQuestions = angularQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Angular" && interviewLevel === "Senior") {
      ...
      const shuffledSenior = seniorAngularQeustions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Java" && interviewLevel === "Senior") {
      const shuffledQuestions = javaQuestions.sort(() => Math.random() - 0.5);
      const shuffledSenior = seniorJavaQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Python" && interviewLevel === "Senior") {
      const shuffledQuestions = pythonQuestions.sort(() => Math.random() - 0.5);
      const shuffledSenior = seniorPythonQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Data Scientist" && interviewLevel === "Junior") {
      const shuffledQuestions = dataScientistQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Data Scientist" && interviewLevel === "Senior") {
      ...
      const shuffledSenior = seniorDataScientistQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
    ...
    if (interviewJob === "Cybersecurity" && interviewLevel === "Senior") {
      const shuffledQuestions = cyberQuestions.sort(() => Math.random() - 0.5);
      const shuffledSenior = seniorCyberQuestions.sort(
        () => Math.random() - 0.5
      );
      questions.push(
        shuffledQuestions[0],
        ...
        >
          ...
          >
            <Stack
              ...
              alignItems="center"
              sx={{ width: "95%", height: "10%" }}
            >
              <Box sx={{ fontSize: "small", fontWeight: "bold" }}>
                {interviewLevel} {interviewJob} Interview
              </Box>
            ...
            <Stack
              ...
              alignItems="center"
            >
              {questions[1] && questionNumber === 0 ? (
                <TypewriterComponent
                  onInit={(typewriter) => {
                    typewriter
                      .changeDelay(40)
                      .typeString(questions[questionNumber])
                      .start();
                  }}
                />
              ) : null}
              {questions[1] && questionNumber === 1 ? (
                <TypewriterComponent
                  onInit={(typewriter) => {
                    typewriter
                      .changeDelay(40)
            ...
            >
              ...
              >
                ...
                >
                  Hold The Microphone to Start Recording
                </Typography>
              </Stack>
              <Stack
                sx={{ width: "33%" }}
            ...
            >
              ...
              >
                ...
                <Typography variant="subtitle1">
                  Tap Microphone To {listening ? "Stop" : "Start"} Recording
                </Typography>
              </Stack>
              <Stack
                sx={{ width: "33%" }}
